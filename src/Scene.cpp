...
std::array<std::unique_ptr<Geometry>, 17> scene1(Camera c, const int W, const int H)
{
    ...
    geometry[5] = std::unique_ptr<Geometry>(new Plane(Direction(0, 1, 0), Point(W / 2, c.getO().y - c.getU().mod(), c.getF().mod())));
    geometry[8] = std::unique_ptr<Geometry>(new Plane(Direction(0, -1, 0), Point(W / 2, c.getO().y + c.getU().mod(), c.getF().mod())));
    geometry[6] = std::unique_ptr<Geometry>(new Plane(Direction(1, 0, 0), Point(c.getO().x - c.getL().mod(), H / 2, c.getF().mod())));
    geometry[7] = std::unique_ptr<Geometry>(new Plane(Direction(-1, 0, 0), Point(c.getO().x + c.getL().mod(), H / 2, c.getF().mod())));
...
std::array<std::unique_ptr<Geometry>, 12> scene2(Camera c, const int W, const int H)
{
    ...
    geometry[0] = std::unique_ptr<Geometry>(new BoundedPlane(
        Point(c.getO().x - c.getL().mod(), H, c.getF().mod()),
        Point(c.getO().x - c.getL().mod(), H, c.getF().mod() + 750),
        Point(c.getO().x - c.getL().mod(), c.getO().y - c.getU().mod(), c.getF().mod() + 750),
        Point(c.getO().x - c.getL().mod(), c.getO().y - c.getU().mod(), c.getF().mod())));
